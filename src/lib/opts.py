...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='dair-v2x',
                             help='coco | kitti | coco_hp | pascal | car_UE4 | carla | traffic_lights')
    ...
    self.parser.add_argument('--arch', default='dla_34', 
                             help='model architecture. Currently tested'
                                  ...
                                  'dlav0_34 | dla_34 | hourglass | dis_34')
    ...
    self.parser.add_argument('--lr_step', type=str, default='90,120,150,180,210,240,270,300',
                             help='drop learning rate by 10.')
    self.parser.add_argument('--num_epochs', type=int, default=400,
    ...
    self.parser.add_argument('--save_dcor_plots', action='store_true')
    self.parser.add_argument('--save_dcor_plots_dir', default='dcor_plots')
    ...
    self.parser.add_argument('--dis_weight', type=float, default=0.1,
                             help='loss weight for distance.')
    # multi_pose
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_classes': 3, 
                'mean': [0.67912669, 0.68251455, 0.67205669], 'std': [0.25812324, 0.25614174, 0.26644599],
                'dataset': 'carla'},
